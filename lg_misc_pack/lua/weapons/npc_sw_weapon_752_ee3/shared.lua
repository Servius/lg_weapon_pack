...
if ( CLIENT ) then
	...
	killicon.Add( "npc_sw_weapon_752_ee3", "HUD/killicons/EE3", Color( 255, 80, 0, 255 ) )
...
local FireSound 			= Sound ("weapons/EE3_fire.wav");
local ReloadSound			= Sound ("weapons/EE3_reload.wav");
...
function SWEP:PrimaryAttack()
	...
	// In singleplayer this funtion doesn't get called on the client, so we use a networked float
