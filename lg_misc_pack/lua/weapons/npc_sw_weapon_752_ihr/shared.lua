...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "NPC_Imperial Heavy Repeater"			
	...
	killicon.Add( "npc_sw_weapon_752_ihr", "HUD/killicons/IHR", Color( 255, 80, 0, 255 ) )
...
local FireSound 			= Sound ("weapons/IHR_fire.wav");
local ReloadSound			= Sound ("weapons/IHR_reload.wav");
...
SWEP.Primary.Tracer 		= "effect_sw_laser_yellow"
