SWEP.Gun					= ("tfa_sw_repshot") --Make sure this is unique.  Specically, your folder name.  
...
SWEP.PrintName				= "Republic Shotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel			= "models/swbf3/rep/shotgun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-6.8, -5, 4)
SWEP.IronSightsAng = Vector(-4.35, -0.6, 0)
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-1.349, 3.45, 1.069), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(5, 5, 0) },
