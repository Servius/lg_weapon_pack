...
function SWEP:SetupWeaponHoldTypeForAI( t )
	...
	self.ActivityTranslateAI [ ACT_RANGE_ATTACK1_LOW ] 			= ACT_RANGE_ATTACK_PISTOL
	...
	self.ActivityTranslateAI [ ACT_WALK_STIMULATED ] 			= ACT_WALK_PISTOL
	self.ActivityTranslateAI [ ACT_WALK_AGITATED ] 				= ACT_WALK_AIM_PISTOL

	self.ActivityTranslateAI [ ACT_RUN_RELAXED ] 				= ACT_RUN
	self.ActivityTranslateAI [ ACT_RUN_STIMULATED ] 			= ACT_RUN_PISTOL
	self.ActivityTranslateAI [ ACT_RUN_AGITATED ] 				= ACT_RUN_AIM_PISTOL
	
	self.ActivityTranslateAI [ ACT_CROUCH ] 					= ACT_IDLE_ANGRY_PISTOL	
	self.ActivityTranslateAI [ ACT_CROUCHIDLE ] 				= ACT_IDLE_ANGRY_PISTOL
	self.ActivityTranslateAI [ ACT_COVER_LOW ] 					= ACT_IDLE_ANGRY_PISTOL
	self.ActivityTranslateAI [ ACT_RANGE_AIM_LOW ] 				= ACT_IDLE_ANGRY_PISTOL
	self.ActivityTranslateAI [ ACT_RELOAD_LOW ] 				= ACT_RELOAD_PISTOL
	return end
	...
	if ( t == "melee" ) then
		...
		self.ActivityTranslateAI [ ACT_IDLE_RELAXED ] 				= ACT_IDLE_PISTOL
		self.ActivityTranslateAI [ ACT_IDLE_STIMULATED ] 			= ACT_IDLE_PISTOL
		self.ActivityTranslateAI [ ACT_IDLE_AGITATED ] 				= ACT_IDLE_ANGRY_PISTOL

		self.ActivityTranslateAI [ ACT_WALK_RELAXED ] 				= ACT_WALK
		self.ActivityTranslateAI [ ACT_WALK_STIMULATED ] 			= ACT_WALK_PISTOL
		self.ActivityTranslateAI [ ACT_WALK_AGITATED ] 				= ACT_WALK_PISTOL
	...
	if ( t == "pistol" ) then
		self.ActivityTranslateAI [ ACT_RANGE_ATTACK1 ] 				= ACT_RANGE_ATTACK_AR2
		self.ActivityTranslateAI [ ACT_MELEE_ATTACK1 ] 				= ACT_IDLE_ANGRY_SMG1
		self.ActivityTranslateAI [ ACT_RELOAD ] 					= ACT_RELOAD_SMG1
		self.ActivityTranslateAI [ ACT_IDLE ] 						= ACT_IDLE_SMG1
		self.ActivityTranslateAI [ ACT_IDLE_ANGRY ] 				= ACT_IDLE_ANGRY_SMG1
		self.ActivityTranslateAI [ ACT_WALK ] 						= ACT_WALK_RIFLE
		...
		self.ActivityTranslateAI [ ACT_WALK_AIM ] 					= ACT_WALK_AIM_RIFLE
		self.ActivityTranslateAI [ ACT_WALK_CROUCH ] 				= ACT_WALK_RIFLE_RELAXED
		...
		self.ActivityTranslateAI [ ACT_CROUCH ] 				    = ACT_IDLE_ANGRY_SMG1		
		self.ActivityTranslateAI [ ACT_CROUCHIDLE ] 				= ACT_IDLE_ANGRY_SMG1
		self.ActivityTranslateAI [ ACT_COVER_LOW ] 					= ACT_IDLE_ANGRY_SMG1
		self.ActivityTranslateAI [ ACT_RANGE_AIM_LOW ] 				= ACT_IDLE_ANGRY_SMG1
		self.ActivityTranslateAI [ ACT_RANGE_ATTACK1_LOW ] 			= ACT_RANGE_ATTACK_SMG1
