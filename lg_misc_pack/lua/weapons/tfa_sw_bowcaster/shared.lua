SWEP.Gun					= ("tfa_sw_cisshot") --Make sure this is unique.  Specically, your folder name.  
...
SWEP.PrintName				= "Bowcaster"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound 			= Sound ("lazeroussounds/weapons/BOWCASTER_fire.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.DamageType = bit.bor(DMG_SHOCK,DMG_BLAST)--See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.
...
SWEP.Primary.DefaultClip			= 25					-- This is the number of bullets the gun gives you, counting a clip as defined directly above.
...
SWEP.Primary.IronAccuracy = 0.0125/2	-- Ironsight accuracy, should be the same for shotguns
...
SWEP.ViewModel			= "models/weapons/cstrike/c_snip_awp.mdl" --Viewmodel path
...
SWEP.ScopeScale = 1.0 --Scale of the scope overlay
...
SWEP.IronSightsPos = Vector(-7.321, -8.495, 2.759)
...
SWEP.BlowbackVector = Vector(0,-5,0.2) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.SmokeParticles = { pistol = "",  --These are particle effects INSIDE a pcf file, not PCF files, that are played when you shoot.
...
SWEP.TracerName 		= "effect_sw_laser_green" 	--Change to a string of your tracer name.  Can be custom.
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 2.421, 0) },

	["v_weapon.awm_parent"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },

	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0.231, -0.128), angle = Angle(0, 0, 0) },

	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -6.794, 0) },

	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 3.917, 0) }
...
SWEP.VElements = {
	...
	["element_name"] = { type = "Model", model = "models/swbf3/outerrim/weapons/bowcaster.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0, 2.493, -2.595), angle = Angle(-86.223, 90, 0), size = Vector(1.202, 1.202, 1.202), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.WElements = {
	...
	["w_element_name"] = { type = "Model", model = "models/swbf3/outerrim/weapons/bowcaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.449, 1.248, 2.582), angle = Angle(-5.074, 3.872, 180), size = Vector(1.202, 1.202, 1.202), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
...
SWEP.Callback.ChooseProceduralReloadAnim = function(self)
	...
	self:EmitSound("lazeroussounds/weapons/BOWCASTER_reload.wav")
