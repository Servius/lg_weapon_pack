SWEP.Gun					= ("tfa_sw_cissnip") --Make sure this is unique.  Specically, your folder name.  
...
SWEP.PrintName				= "CIS Sniper"		-- Weapon name (Shown on HUD)	
...
--Firing related
SWEP.Primary.Sound 			= Sound("TFA_SW_CISSNIP.1")				-- This is the sound of the weapon, when you shoot.
...
SWEP.ViewModel			= "models/weapons/cstrike/c_snip_scout.mdl" --Viewmodel path
...
SWEP.IronSightsPos = Vector(-6.665, -22, 2.391)
...
SWEP.BlowbackVector = Vector(0,-3,0.1) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_L_Finger02"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 13.739, 0) },
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -23.553, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-0.75, -1.392, -0.341), angle = Angle(-2.516, -9.259, -6.845) },
	["v_weapon.scout_Parent"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0.2, 0, 0), angle = Angle(12.579, 7.868, 2.869) }
}

SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(0.035, -5.785, -10.783), angle = Angle(90, 180, -1.17), size = Vector(0.163, 0.163, 0.163), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["element_name"] = { type = "Model", model = "models/swbf3/cis/sniperrifle.mdl", bone = "v_weapon.scout_Parent", rel = "", pos = Vector(0, 1.325, -11.08), angle = Angle(-90, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/swbf3/cis/sniperrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.199, 0.63, -0.45), angle = Angle(-11.468, 2.013, 178), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.ShowWorldModel = false


SWEP.Primary.ReloadSound = Sound("TFA_SW_CISSNIP.Reload")
