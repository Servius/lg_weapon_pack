...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "KOTOR Blaster Rifle"			
	SWEP.Author				= "Syntax_Error752"
	SWEP.ViewModelFOV		= 50
	SWEP.Slot				= 2
	SWEP.SlotPos			= 3
	SWEP.WepSelectIcon 		= surface.GetTextureID("HUD/killicons/KOTOR/blaster_rifle")
	
	killicon.Add( "weapon_752_KOTOR_blaster_rifle", "HUD/killicons/KOTOR/blaster_rifle", Color( 255, 80, 0, 255 ) )
...
SWEP.ViewModel				= "models/weapons/KOTOR/v_blaster_rifle.mdl"
...
SWEP.IronSightsPos 			= Vector (-4.75, -12, 1.1)
