...
SWEP.IronSightsPos = Vector(-6.52, -14.08, 5)
...
SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(0.065, -5.45, 2.28), angle = Angle(90, 180, 0), size = Vector(0.333, 0.333, 0.333), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} },
	["wep"] = { type = "Model", model = "models/swbf3/rep/sniperrifle.mdl", bone = "v_weapon.AK47_Parent", rel = "", pos = Vector(-0.049, 0.875, -8.695), angle = Angle(-87.015, 88.999, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
