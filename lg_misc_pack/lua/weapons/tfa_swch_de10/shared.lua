...
SWEP.Primary.Sound = Sound ("weapons/DE10_fire.wav");
SWEP.Primary.ReloadSound = Sound ("weapons/DE10_reload.wav");
...
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/rtcircle.mdl", bone = "Box01", rel = "", pos = Vector(0.649, -3.79, -0.08), angle = Angle(0, 180, 0), size = Vector(0.256, 0.256, 0.256), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
...
SWEP.RTCode = function( self, mat )
	...
	if AngPos then
		...
		ang:RotateAroundAxis(ang:Right(), -0.1)
		ang:RotateAroundAxis(ang:Up(), 1.45)
