...
if ( CLIENT ) then
	...
	SWEP.PrintName			= "Defender Sporting Blaster Pistol"			
	SWEP.Author				= "Syntax_Error752"
	SWEP.ViewModelFOV      	= 70
	SWEP.Slot				= 1
	SWEP.SlotPos			= 5
	SWEP.WepSelectIcon = surface.GetTextureID("HUD/killicons/DSBP")
	
	killicon.Add( "weapon_752_dsbp", "HUD/killicons/DSBP", Color( 255, 80, 0, 255 ) )
...
local FireSound 			= Sound ("weapons/DSBP_fire.wav");
local ReloadSound			= Sound ("weapons/DSBP_reload.wav");
...
SWEP.IronSightsPos 			= Vector (-3.8, -6, 2.4)
