...
SWEP.PrintName				= "CIS Shotgun"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/cstrike/c_shot_xm1014.mdl" --Viewmodel path
...
SWEP.WorldModel			= "models/swbf3/cis/shotgun.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-7.04, 0, 2.759)
SWEP.IronSightsAng = Vector(-3.302, -0.801, 0)
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_L_Finger01"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, -20.351, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-0.678, 3.213, 0.36), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Finger0"] = { scale = Vector(1, 1, 1), pos = Vector(0, -0.06, 0), angle = Angle(0.765, 7.966, 0) }
}

SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/swbf3/cis/shotgun.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(-0.173, 1.652, -9.554), angle = Angle(-87.012, 90, 0), size = Vector(1.105, 1.105, 1.105), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.Primary.ReloadSound = Sound("TFA_SW_CISSHOT.Reload")
